...
import NETCore from "../assets/ASPNET.png";
...
const Skills = () => {
  return (
    <div className="w-full min-h-screen bg-[#0a192f] text-gray-300">
      <Navbar />
      <div className="max-w-[1000px] mx-auto flex flex-col justify-center h-full w-full p-4 pt-20 pb-10">
        ...
        <div className="grid w-full grid-cols-2 gap-4 p-5 text-center sm:grid-cols-4">
          <div className="shadow-lg shadow-[#040c16] hover:scale-110 duration-500 pt-5">
          ...
          <div className="shadow-lg shadow-[#040c16] hover:scale-110 duration-500 pt-5">
            <img className="w-20 mx-auto" src={Bootstrap} alt="Github icon" />
            <p className="my-4">Bootstrap</p>
          </div>
          <div className="shadow-lg shadow-[#040c16] hover:scale-110 duration-500 pt-5">
            <img className="w-20 mx-auto" src={JQuery} alt="Github icon" />
